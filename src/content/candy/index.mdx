...
date: '2018-12-12'
videoId: Dn_kHCFTUP4
codesandboxId: ov0lzxmplz
dataset: statistic_id947149_retail-sales-of-candy-in-the-united-states-in-2018-by-week.xlsx
intro: Candy is delicious. When do people buy it most? Visualize the data in a fun way
image: './candy.png'
---
...
<TweetEmbed id="1073285327282876416" options={{ conversation: 'none' }} />

Randomness on the CandyJar level.

<TweetEmbed id="1073285329237401600" options={{ conversation: 'none' }} />

Randomness on the CandyJar _and_ Candy level.

<TweetEmbed id="1073285332555194369" options={{ conversation: 'none' }} />

Randomness in the start position as well.

<TweetEmbed id="1073285334291501056" options={{ conversation: 'none' }} />
